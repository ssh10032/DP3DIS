...
class HungarianMatcher(nn.Module):
    ...
    def __init__(self, cost_class: float = 1, cost_mask: float = 1, cost_dice: float = 1, cost_box: float = 1, cost_giou: float = 1, num_points: int = 0):
        """Creates the matcher
        ...
        Params:
            ...
            ##### add cost_box & cost_giou for bbox predition loss -0822 songoh #####
        """
        super().__init__()
        ...
        assert cost_class != 0 or cost_mask != 0 or cost_dice != 0 or cost_box != 0, "all costs cant be 0"
